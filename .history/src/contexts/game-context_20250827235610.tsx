...
export const GameContextProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const startAggressivePolling = useCallback(() => {
        ...
        pollWithBackoff();
    }, [isPollingAggressively, refreshGameState, stopAggressivePolling]);
    ...
    }, [signer, chainId, attempts, isPollingAggressively, startAggressivePolling, stopAggressivePolling]);
    ...
    }, [nbNewGuesses, refreshGameState, signer, chainId]);
