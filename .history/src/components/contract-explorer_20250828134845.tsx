          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              ...
              <Alert severity="info" sx={{ fontSize: '0.7rem', py: 0.5 }}>
                🔗 Using Substrate RPC methods: `chain_getHeader`, `state_getStorage`, `chain_getBlock` for real blockchain data.
              </Alert>
            </Box>
          </Box>
        </Box>
                ...
                <Box>
                  <FormControl fullWidth sx={{ mb: 2 }}>
                    ...
                    >
                      ...
                      <MenuItem value="get_current_game">get_current_game</MenuItem>
                      <MenuItem value="get_current_game_from">get_current_game_from</MenuItem>
                      <MenuItem value="AccessControl::has_role">AccessControl::has_role</MenuItem>
                      <MenuItem value="AccessControl::grant_role">AccessControl::grant_role</MenuItem>
                      <MenuItem value="RollupClient::get_value">RollupClient::get_value</MenuItem>
                      <MenuItem value="RollupClient::has_message">RollupClient::has_message</MenuItem>
                      <MenuItem value="MetaTransaction::prepare">MetaTransaction::prepare</MenuItem>
                    </Select>
                  </FormControl>
                  ...
                  {!searchError && (
                    <Box sx={{ mt: 2 }}>
                      ...
                      <Alert severity="info" sx={{ fontSize: '0.7rem' }}>
                        🔧 <strong>Technical Implementation:</strong> Using Substrate RPC methods for Pop Network.
                        Methods: <code>chain_getHeader</code>, <code>state_getStorage</code>, <code>chain_getBlock</code>.
                        Contract events decoded using metadata signatures.
                      </Alert>
                    </Box>
                  )}
                </Box>
                ...
                {!isUsingRealData && (
                  <Box sx={{ mt: 1 }}>
                    <Typography variant="caption" sx={{ color: '#64b5f6', display: 'block', mb: 1 }}>
                      🔗 Connected to Pop Network using Substrate RPC methods!
                    </Typography>
                    <Typography variant="caption" sx={{ color: '#888', display: 'block', fontSize: '0.7rem' }}>
                      📊 Using real Substrate methods: `chain_getHeader`, `state_getStorage`, `chain_getBlock` to retrieve live blockchain data.
                    </Typography>
                  </Box>
                )}
              </Box>
