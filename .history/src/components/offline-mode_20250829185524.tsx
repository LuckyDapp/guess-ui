...
import { Game, BugReport, AccountBalance } from '@mui/icons-material';
...
export function OfflineMode({ currentPage }: OfflineModeProps) {
    ...
    // Demo transactions for explorer
                ...
                <Box sx={{ padding: { xs: "40px 20px 0", sm: "60px 40px 0" }, display: 'flex', justifyContent: 'center' }}>
                    <Box className="content-block fade-in" sx={{ width: '100%', maxWidth: '700px', borderRadius: '24px', p: { xs: 3, sm: 4 } }}>
                        ...
                        <Alert severity="warning" sx={{ mt: 2 }}>
                            🚨 Demo Mode - No blockchain connection detected
                        </Alert>
                    </Box>
                </Box>
        ...
        return (
            <Box sx={{ width: '100%', p: 2 }}>
                ...
                <Alert severity="warning" sx={{ mb: 2 }}>
                    🚨 Demo Mode - Using cached/local data (no blockchain connection)
                </Alert>

                <Alert severity="info" sx={{ mb: 2 }}>
                    Connected to Demo Network • Contract: 0xDEMO1234567890abcdef • Using Cached Data
                </Alert>
                ...
                {/* Transactions Tab */}
                <Card sx={{ mb: 2 }}>
                    <CardHeader title="Transaction History (Demo Data)" />
                    <CardContent>
                ...
                {/* Events Tab */}
                <Card>
                    <CardHeader title="Contract Events (Demo Data)" />
                    <CardContent>
                        <TableContainer component={Paper}>
                            <Table size="small">
                                <TableHead>
        ...
        return (
            <Box sx={{ width: '100%', p: 2 }}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Typography><strong>Mode:</strong> Offline/Demo</Typography>
