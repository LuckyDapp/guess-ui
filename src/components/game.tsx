import { Suspense, useContext, useRef, useState, useEffect, useMemo } from "react";
    ...
    switch (event.value.type) {
      case 'finalized':
        if (event.value.ok) {
          ...
          // Définir le numéro d'essai attendu (game.attempt + 1 après la transaction)
          if (game) {
            setExpectedAttemptNumber((game.attempt || 0) + 1);
          }
